...
export default function Contact() {
  return (
    <div className='h-full bg-black text-white flex flex-col justify-start items-center w-full gap-5 sm:gap-10 p-[20px] sm:p-[50px] relative'>
      <div className=" flex gap-[20px]">
      <div><h1 className="text-[20px] md:text-[50px] underline">linkedin.</h1></div>
      <div><h1 className="text-[20px] md:text-[50px] underline">twitter.</h1></div>
      <div><h1 className="text-[20px] md:text-[50px] underline">email.</h1></div>
      </div>
